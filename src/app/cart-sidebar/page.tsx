...
// // //   return (
// // //     <div className="flex justify-between items-start px-8 py-10 gap-10">
...
// // //           <div className="absolute top-0 right-0 bg-white shadow-lg rounded-lg p-6 w-96">
// // //             <h2 className="text-lg font-bold text-center border-b pb-4">Shopping Cart</h2>
// // //             <div className="space-y-6 mt-6">
// // //               {cartItems.map((item) => (
// // //                 <div
...
// //           {/* Shopping Cart Overlay */}
// //           <div className="absolute top-0 right-0 bg-white shadow-lg rounded-lg p-4 w-60 h-auto max-h-[500px] overflow-y-auto">
// //             {/* Shopping cart ki width 72 kar di (kam) aur height auto set ki. 
// //                 Max height ko 500px set kiya aur overflow auto diya. */}
// //             <h2 className="text-lg font-bold text-center border-b pb-4">Shopping Cart</h2>
// //             <div className="space-y-6 mt-6">
// //               {cartItems.map((item) => (
// //                 <div
...
//             {/* Shopping cart ko image ke upar rakha gaya hai */}
//             <h2 className="text-lg font-bold text-center border-b pb-4">Shopping Cart</h2>
//             <div className="space-y-6 mt-6">
//               {cartItems.map((item) => (
//                 <div
...
//           {/* Image ko relative position diya gaya hai taake shopping cart uske andar show ho */}
//           <Image
//             src="/Group110.png"
//             alt="Statement Image"
//             width={1200}
